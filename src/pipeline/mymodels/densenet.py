...
def densenet121(pretrained=False, **kwargs):
    ...
    model = DenseNet(num_init_features=64, growth_rate=32,
                     ...
                     **kwargs)
    if pretrained:
        model = _load_pretrained_weights(model, 'densenet121')
    return model
...
def densenet169(pretrained=False, **kwargs):
    ...
    model = DenseNet(num_init_features=64, growth_rate=32,
                     ...
                     **kwargs)
    if pretrained:
        model = _load_pretrained_weights(model, 'densenet169')
    return model
...
def densenet201(pretrained=False, **kwargs):
    ...
    model = DenseNet(num_init_features=64, growth_rate=32,
                     ...
                     **kwargs)
    if pretrained:
        model = _load_pretrained_weights(model, 'densenet201')
    return model
...
def densenet161(pretrained=False, **kwargs):
    ...
    model = DenseNet(num_init_features=96, growth_rate=48,
                     ...
                     **kwargs)
    if pretrained:
        model = _load_pretrained_weights(model, 'densenet161')
    return model
...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
                 ...
                 num_classes=1000, more_feats=False):
        ...
        if not more_feats:
            ...
            self.classifier = nn.Linear(num_features + 9, num_classes)
