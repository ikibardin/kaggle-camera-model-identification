...
from mymodels.resnext import resnext101_32x4d
...
parser.add_argument('-g', '--gpus', type=int, default=2, help='Number of GPUs to use')
...
if args.use_imagenet_weights:
    ...
    pretrained = False
model = resnext101_32x4d(num_classes=len(CLASSES), pretrained=pretrained)
