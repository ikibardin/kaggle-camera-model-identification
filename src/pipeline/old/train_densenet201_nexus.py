...
def load_train_ids():
    ...
    ids_train = [name for name in ids_train if utils.CLASSES[0] in name or utils.CLASSES[1] in name]
...
def load_model(args):
    ...
    model = densenet201(num_classes=2, pretrained=args.use_imagenet_weights)
